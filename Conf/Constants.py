...
# Rings
Rings = {
    "AxeRing": {"Name": "AxeRing", "Precision": 0.8},
    "BrokenKeyRing": {"Name": "BrokenKeyRing", "Precision": 0.8},
    "BrokenRingOfEnding": {"Name": "BrokenRingOfEnding", "Precision": 0.8},
    "ButterflyRing": {"Name": "ButterflyRing", "Precision": 0.8},
    "ClubRing": {"Name": "ClubRing", "Precision": 0.8},
    "CrystalRing": {"Name": "CrystalRing", "Precision": 0.8},
    "DeathRing": {"Name": "DeathRing", "Precision": 0.8},
    "DwarvenRing": {"Name": "DwarvenRing", "Precision": 0.8},
    "EnergyRing": {"Name": "EnergyRing", "Precision": 0.8},
    "GoldRing": {"Name": "GoldRing", "Precision": 0.8},
    "LifeRing": {"Name": "LifeRing", "Precision": 0.8},
    "MightRing": {"Name": "MightRing", "Precision": 0.8},
    "PowerRing": {"Name": "PowerRing", "Precision": 0.8},
    "RingOfBluePlasma": {"Name": "RingOfBluePlasma", "Precision": 0.8},
    "RingOfHealing": {"Name": "RingOfHealing", "Precision": 0.8},
    "StealthRing": {"Name": "StealthRing", "Precision": 0.8},
    "SweetheartRing": {"Name": "SweetheartRing", "Precision": 0.8},
    "SwordRing": {"Name": "SwordRing", "Precision": 0.8},
    "TimeRing": {"Name": "TimeRing", "Precision": 0.8},
    "WeddingRing": {"Name": "WeddingRing", "Precision": 0.8}
}
